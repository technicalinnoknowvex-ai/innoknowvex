...
export const getProgramById = async (programId) => {
  try {
    ...
    if (exactError) {
      console.error("Error fetching program:", exactError);
      return null;
    }

    if (exactProgram) {
      console.log("Fetched program:", exactProgram.title);
      return exactProgram;
    }

    // Fallback for mixed-case IDs in database.
    ...
    if (fallbackError) {
      console.error("Error fetching program via fallback:", fallbackError);
      return null;
    }
    ...
    console.log("Fetched program via fallback:", fallbackProgram.title);
