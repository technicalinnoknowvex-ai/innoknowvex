...
//   const coursesLower = applicableCourses.map(course => course.toLowerCase().trim());
...
//           console.log('Coupon not found:', couponCode.toUpperCase(), 'Error:', error);
//           return new Response(
//             JSON.stringify({
...
//         if (matchingCouponRow.is_active === false) {
//           return new Response(
//             JSON.stringify({
...
//         if (originalAmount < matchingCouponRow.minimum_amount) {
//           return new Response(
//             JSON.stringify({
//               message: `Minimum order amount of ₹${matchingCouponRow.minimum_amount} required for this coupon`,
//               success: false
//             }),
//             {
//               status: 400,
...
//         const applicableCoursesArray = Array.isArray(matchingCouponRow.applicable_courses) ? matchingCouponRow.applicable_courses : ['all'];
//         if (!isCouponApplicableToCourse(applicableCoursesArray, courseId, course)) {
//           return new Response(
//             JSON.stringify({
