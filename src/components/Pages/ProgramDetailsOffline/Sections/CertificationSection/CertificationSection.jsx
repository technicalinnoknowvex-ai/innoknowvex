...
export default function CertificationSection({ program, isOffline }) {
  ...
  return (
    ...
    >
      ...
      <div className={`${styles.starImg} ${shouldAnimate ? styles.animateIn : ""}`}>
      ...
      <div className={`${styles.images} ${shouldAnimate ? styles.animateImages : ""}`}>
        <div
          className={`${styles.certWrap} ${styles.leftCert} ${
            imagesVisible ? styles.certVisible : ""
          }`}
        >
          <Image
        ...
        <div
          className={`${styles.certWrap} ${styles.rightCert} ${
            imagesVisible ? styles.certVisible : ""
          }`}
        >
          <Image
