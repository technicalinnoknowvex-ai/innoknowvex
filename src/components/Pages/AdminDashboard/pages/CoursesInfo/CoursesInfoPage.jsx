...
//       // Fetch pricing data with better error handling
//       let pricingData = null;
//       try {
//         pricingData = await getPricingByCourse(program.title);
//         console.log('✅ Pricing data received:', pricingData);
//       } catch (error) {
//         console.warn('⚠️ No pricing data found for course:', program.title, error);
