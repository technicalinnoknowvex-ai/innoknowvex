        ...
        <div ref={contentRef} className={styles.heroContent}>
          <div ref={textWrapperRef} className={styles.textWrapper}>
            ...
            {/* At INNOKNOWVEX EDUTECH, we go beyond traditional learning to transform your
              ...
              At INNOKNOWVEX EDUTECH, we turn your potential into real-world success with
              practical training, live projects, and expert mentorship. We do not just
              teach - we prepare you to perform, stand out, and confidently start your
              career.
            </p>
