  ...
  useGSAP(
    () => {
      ...
      contentTl
        ...
        .to(carouselRef.current, { y: 0, opacity: 1, duration: 0.75, ease: "power2.out" }, "-=0.35");
    },
    { scope: sectionRef }
  );
    ...
    <div className={styles.landing} ref={sectionRef} id="blogs">
      <div className={styles.headingSection}>
        <div className={styles.sectionHeadingContainer}>
          ...
          <h2 ref={headingRef} className={`${styles.sectionHeadingContainer__primaryHeading} gradientHeading`}>
            Blog
          </h2>
        </div>
        <h3 ref={subheadingRef} className={styles.sectionHeadingContainer__secondaryHeading}>
          Discover our latest insights and stories
        </h3>
      </div>
      <div ref={carouselRef} className={styles.carouselContainer} style={{ position: 'relative' }}>
