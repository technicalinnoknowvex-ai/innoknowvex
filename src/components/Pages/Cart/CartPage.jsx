...
//     // CRITICAL: Price validation state
...
//                 plan: item.plan,
//                 price: item.price,
//                 priceSearchTag: item.price_search_tag
//             }));
//         } else {
...
//                 priceSearchTag: storedItems[0].price_search_tag
//             }] : [];
//         }
//     }
...
//                 console.log("✅ Loaded Tech Starter Pack items:", packageData.items.length);
//             } else if (techPackCart) {
//                 const techCartItems = JSON.parse(techPackCart);
//                 if (techCartItems.length > 0) {
//                     setStoredItems(techCartItems);
//                     const updatedPackageInfo = {
//                         ...packageData,
//                         items: techCartItems,
...
//         if (pricesLoading) return "Validating prices...";
...
//                                                     {isPriceInvalid ? (
//                                                         <div className={style.itemPrice} style={{ color: '#f00' }}>
//                                                             Loading...
//                                                         </div>
//                                                     ) : (
//                                                         <>
...
//                             style={{
//                                 opacity: (hasInvalidPrice || pricesLoading) ? 0.5 : 1,
//                                 cursor: (hasInvalidPrice || pricesLoading) ? 'not-allowed' : 'pointer'
//                             }}
//                         >
//                             {hasInvalidPrice ? 'Loading prices...' : pricesLoading ? 'Validating...' : 'Go to Checkout'}
//                         </button>
//                     </div>
//                 </div>
//             </div>
